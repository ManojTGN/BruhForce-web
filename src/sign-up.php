...
<html>
    ...
    <body style="background:#00ADB5">
        ...
        <div style="background:#00ADB5" class="container-fluid">           
            <form method="POST">
            <div class="card mx-auto" style="width: 30%;margin-top:10%;background:#393E46;">
                <div class="card-body">
                <h5 style="color:white;"class="card-title">Sign Up</h5><br>
                <form method="POST">
                ...
                <br>
                <div class="input-group flex-nowrap" style="width: 300px;">
                    <span  style="background:#393E46;color:white;"class="input-group-text" id="addon-wrapping">phone no</span>
                ...
                <br>
                <div class="input-group flex-nowrap" style="width: 300px;">
                    <span  style="background:#393E46;color:white;"class="input-group-text" id="addon-wrapping">Email ID</span>
                ...
                <div style="text-align: left;" style="width: 200px;">
                    <button style="background:#00ADB5;border-color:#00ADB5"type="submit" name="createUser" class="btn btn-primary">Sign up</button>
                    <a href="sign-in.php"><button style="color:#00ADB5;" type="button" class="btn btn-link">Sign In</button></a>
                </div>
                </form>    
