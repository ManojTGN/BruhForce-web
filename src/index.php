        ...
        <?php if($_SESSION['AccountChoice'] == 0){?>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    <h3 id="childrenOrderName">Example Dish</h3>
                    <div class="row">
                        <div class="col-4">
                        ...
                        <div class="col-8">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" value="Loading..." disabled>
                            </div>
                            <div class="input-group mb-3">
                ...
                <div class="align" style="text-align:center;">  
                    <label>
                        <div class="card" style="width: 18rem;">
                            <img class="card-img-top" height="190" src="https://assets.cntraveller.in/photos/627a4112cbc04ca509426501/4:3/w_2932,h_2199,c_limit/Vegetarian%20South%20Indian%20breakfast%20thali%20-%20Idli%20vada%20sambar%20chutney%20-%20Image%20ID%202H3783R%20(RF).jpg" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">IDLI</h5>
                                <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ChildrenOrder">ORDER</a>
                            </div>
                        </div>
                    </label>
                    <label>
                        <div class="card" style="width: 18rem;">
                            <img class="card-img-top" HEIGHT="190" src="https://recipes.timesofindia.com/thumb/63841432.cms?width=1200&height=900" alt="Card image cap">
                            <div class="card-body">
                    ...
                    <label>
                        <div class="card" style="width: 18rem;">
                            <img class="card-img-top" height="190" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTqTs6KzJOCF0mn1dCgMemd8etambeExI8pBA&usqp=CA">
                            <div class="card-body">
                    ...
                    <label>
                        <div class="card" style="width: 18rem;">
                            <img class="card-img-top" HEIGHT="190" src="https://food.fnr.sndimg.com/content/dam/images/food/fullset/2020/02/10/0/FNK_One-Pan-Egg-Cheese-Omelet-Sandwich_H1_s4x3.jpg.rend.hgtvcom.616.462.suffix/1581344859765.jpeg" alt="Card image cap">
                            <div class="card-body">
                    ...
                    <label>
                        <div class="card" style="width: 18rem;">
                            <img class="card-img-top" height="190" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTv5m3iDtoUs6Zd7926EHhj78NyUtE8vCXBnH5lhcAKIya2BBlAkFvSgzRct1Ylc1zO8xM&usqp=CAU" alt="Card image cap">
                            <div class="card-body">
                    ...
                    <label>
                        <div class="card" style="width: 18rem;">
                            <img class="card-img-top" height="190" src="https://www.oetker.in/Recipe/Recipes/oetker.in/in-en/peanut-butter/image-thumb__52670__RecipeDetailsLightBox/grilled-peanut-butter-jam-sandwich.jpg">
                            <div class="card-body">
